...
public class DiscipuladoMenoresController {
    ...
    public ResponseEntity<List<SimplePersona>> fetchDiscipuladoMenoresInscritosById(@PathVariable String id) {

        return discipuladoMenoresService.getDiscipuladoMenoresInscritosById(id);
    }

    @GetMapping("/{id}/monitores")
    public ResponseEntity<List<Persona>> fetchDiscipuladoMenoresMonitoresById(@PathVariable String id) {
    ...
    @PutMapping("/update")
    public ResponseEntity<String> updateDiscipuladoMenores(@RequestBody @Valid DiscipuladoMenores discipuladoMenores) {
